...
function Skills({ darkMode }) {
  const skills = [
    { name: 'premiere', icon: premiere, level: 70, color: 'from-purple-600 to-indige-500' },
    { name: 'photoshop', icon: photoshop, level: 80, color: 'from-blue-600 to-indige-500' },
    { name: 'office programs', icon: office , level: 90, color: 'from-red-600 to-indige-500' },
   

  ]
  return (
    <section id="skills"
      style={{ backgrondColor: darkMode ? '#111827' : '#f9fafb' }}
      ...
      <div className='py-14 relative overflow-hidden '>
        <div className='container px-5 py-14 mx-auto'>
          <div className='text-center mb-20' data-aos='fade-up' data-aos-delay=''>
            ...
            <p className='text-lgmax-w-2xl mx-auto leading-relaxed '
              style={{
                color: darkMode ? "yellow" : "#6b7280"
              }}
            >المهارات والبرامج التي اعمل عليها
            </p>
          ...
          >
            {skills.map((skill, index) => (
              ...
              >
                <div
                  style={{
                    backgroundColor: darkMode ? 'linear-gradient(to bottom , #1f2937,#111827)'
                      : 'linear-gradient(to bottom , #ffffff,#f3f4f6)', borderColor: darkMode ?
                        '#374151' : '#e5e7eb'
                  }}
                  className='h-full p-6 rounded-2xl border hover:border-orange-500/50 transition-all 
                  duration-300 hover:translate-y-2 group
                   hover:shadow-[0_0_30px_rgb(255,146,,0,0.15)]'>
